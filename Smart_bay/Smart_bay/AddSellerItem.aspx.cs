    ...
    public partial class AddSellerItem : System.Web.UI.Page
    {
        ...
        protected void Button10_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("insert into farmer_request_items(farmer_id,category,item_name,weight_quantity,unit_price,id)values(@farmer_id,@category,@item_name,@weight_quantity,@unit_price,@id)", con);
