        ...
        /*  protected void LinkButton4_Click(object sender, EventArgs e)
          ...
          bool checkIfCustomerExists()
          {
              try
              {
                  ...
                  SqlCommand cmd = new SqlCommand("SELECT * from Customer_Table_1 where customer_id='" + TextBox1.Text.Trim() + "';", con);
          ...
          void deleteCustomerByID()
          {
              if (checkIfCustomerExists())
              {
                  try
                  {
                      ...
                      SqlCommand cmd = new SqlCommand("DELETE from Customer_Table_1 WHERE customer_id='" + TextBox1.Text.Trim() + "'", con);
