<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="customerProfile.aspx.cs" Inherits="Smart_bay.customerProfile" %>
       ...
       <div class="row ">
         <div class="col-md-9 mx-auto">
                 ...
                 <center>
                  ...
                  <div class="row">
                      <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:TextBox class="form-control" ID="TextBox12" runat="server" placeholder="Customer ID" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-2">
              ...
              <div class="buttons1">
                 ...
                 <a width="200" id="buttonp" href="customermanagement.aspx" class="btn btn-primary">View Past Orders</a>
              </div>
